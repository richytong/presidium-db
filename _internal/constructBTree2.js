// constructBTree2(ht DiskSortedHashTable, options { unique: boolean, onNode: function, onLeaf: function })
// constructBTree2(ht DiskSortedHashTable, options { unique: boolean, onNode: function, onLeaf: function }, btreeNode object, memo object) -> Promise<>
async function constructBTree2(ht, options, btreeNode = {}, memo = {}) {
  ...
  for (const item of btreeNode.items) {
    ...
    if (leftConditional) {
      ...
      await constructBTree2(ht, options, btreeNode[item.key].leftChild, {
        ...memo,
        height: height + 1,
        isLeaf: (
    ...
    if (rightConditional) {
      ...
      await constructBTree2(ht, options, btreeNode[item.key].rightChild, {
        ...memo,
        height: height + 1,
        isLeaf: (
...
module.exports = constructBTree2
